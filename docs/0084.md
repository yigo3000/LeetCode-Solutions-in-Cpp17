...
此时如果1入栈，则栈顶元素就不是最高的位置，因此要先将栈顶元素出栈
弹出栈顶元素0，计算从0到i能形成的最大矩形面积，其高度就是0所在位置的高度
...
i = 4 => heights[4] < heights[3]，heights[4] < heights[2]，弹出栈顶元素3和2
计算3和2到4能形成的最大矩形面积
...
i = 6，heights[6] < heights[5]，heights[6] < heights[4]，heights[6] < heights[1]，弹出栈顶元素541
计算541到6能形成的最大矩形面积
